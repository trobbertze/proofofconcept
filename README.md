...
[![Build Status](https://travis-ci.org/trobbertze/sample.svg?branch=master)](https://travis-ci.org/trobbertze/sample) [![Dependency Status](https://david-dm.org/trobbertze/sample.svg)](https://david-dm.org/trobbertze/sample) [![devDependency Status](https://david-dm.org/trobbertze/sample/dev-status.svg)](https://david-dm.org/trobbertze/sample#info=devDependencies)
...
## Release History
 * 2014-07-22   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)